...
subplot(2,3,1)
axis([0 10 0 10]);
ca=[0 1 1 0;0 0 1 1];  %The coordinates of the points
[len,wid]=size(ca);
nor=ones(1,wid);
ha=[ca;nor];
...
subplot(2,3,2)
axis([0 10 0 10]);
ha=[0 1 1 0;0 0 1 1]; %The coordinates of the points
[len,wid]=size(ha);
nor=ones(1,wid);
ha=[ha;nor];
...
daspect([1 1 1])
title('square after translation')
...
daspect([1 1 1])
title('square after euclidean')%translation (5,5) and rotation 30бу
